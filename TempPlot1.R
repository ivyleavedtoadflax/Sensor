...
png("/var/www/gfx/daily_temp_plot.png",width=7,height=4.5,units="in",res=200)	 
...
dev.off()
 ...
 png("/var/www/gfx/daily_himidity_plot.png",width=7,height=4.5,units="in",res=200)	
...
dev.off()
 ...
 png("/var/www/gfx/daily_light_plot.png",width=7,height=4.5,units="in",res=200)
